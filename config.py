...
SEQUENCE_FEATURES=      [ 'ID', 'S', 'P', 'P_S', 'LEMMA', 
  'GPOS', 'MORF',  'DTREE',     'FUNC', 'CTREE', 		 
  'PRED',  'ARG', 'CTX_P+1', 'CTX_P-3', 'CTX_P-2', 
	'CTX_P-1', 'CTX_P+2', 'CTX_P+3',  'M_R', 'PRED_1', 
	'T']

SEQUENCE_FEATURES_TYPES=['int', 'int', 'int', 'int',  'txt', 
	'hot', 'hot', 'hot', 'hot', 'hot', 	
	'txt', 'hot',  'txt', 'txt', 'txt',    
	'txt',  'txt', 'txt',  'int',  'txt', 
	'hot']
