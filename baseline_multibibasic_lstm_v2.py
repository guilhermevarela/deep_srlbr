...
if __name__== '__main__':	
	...
	with tf.name_scope('pipeline'):
		inputs, targets, sequence_length = input_fn([dataset_devel], BATCH_SIZE, N_EPOCHS, embeddings, klass_size=KLASS_SIZE)
		inputs_v, targets_v, sequence_length_v = input_fn([dataset_valid], DATASET_VALID_SIZE, 1, embeddings, klass_size=KLASS_SIZE)
