...
python srl.py 16 16 16 --target R IOB --embs-model wan300 --epochs 250 --r-depth 1
...
python srl.py 16 16 16 --target R IOB --embs-model wrd50 --epochs 250 --r-depth 1
...
python srl.py 16 16 16 --target R IOB --embs-model glo50 --epochs 250 --r-depth 1
