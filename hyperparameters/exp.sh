...
#python srl.py 8 8 --target R IOB --embs-model wan50 --epochs 250 --ru LSTM
#python srl.py 16 16 --target R IOB --embs-model wan50 --epochs 250 --ru LSTM --ctx_p 3
#python srl.py 16 16 --target R IOB --embs-model wan50 --epochs 250 --ru GRU
#python srl.py 16 16 16 16 --target R IOB --embs-model wan100 --epochs 250 --ru LSTM
#python srl.py 16 16 16 16 --target R IOB --embs-model wan100 --epochs 250 --ru GRU
#python srl.py 16 16 --target R IOB --embs-model wan100 --epochs 250 --ru LSTM
#python srl.py 16 16 --target R IOB --embs-model wan100 --epochs 250 --ru LSTM --ctx_p 3
#python srl.py 16 16 --target R IOB --embs-model wan300 --epochs 250 --ru LSTM
#python srl.py 16 16 --target R IOB --embs-model wan300 --epochs 250 --ru LSTM --ctx_p 3
#python srl.py 32 16 --target R IOB --embs-model wan300 --epochs 250 --ru GRU
#python srl.py 8 8 --target R IOB --embs-model wrd50 --epochs 250 --ru LSTM
#python srl.py 8 8 --target R IOB --embs-model wrd50 --epochs 250 --ru LSTM --ctx_p 3
#python srl.py 16 16 --target R IOB --embs-model wrd50 --epochs 250 --ru GRU
python srl.py 8 8 --target R IOB --embs-model glo50 --epochs 250 --ru LSTM
python srl.py 8 8 --target R IOB --embs-model glo50 --epochs 250 --ru LSTM --ctx_p 3
#python srl.py 16 16 --target R IOB --embs-model glo50 --epochs 250 --ru GRU
