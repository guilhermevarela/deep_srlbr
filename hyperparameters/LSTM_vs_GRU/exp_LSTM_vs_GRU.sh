...
python srl.py 16 16 --target R IOB --embs-model wrd50 --epochs 150
python srl.py 32 16 --target R IOB --embs-model wan300 --ru GRU --epochs 150 --batch_size 100
python srl.py 16 16 16 16 --target R IOB --embs-model wan100 --ru GRU --epochs 150 --batch_size 100
python srl.py 16 16 --target R IOB --embs-model glo50 --ru GRU --epochs 150 --batch_size 100
python srl.py 16 16 --target R IOB --embs-model wan50 --epochs 150 --batch_size 100
