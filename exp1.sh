...
python srl.py 16 16 --target R T --embs-model wan50
python srl.py 16 16 16 16 --target R T --embs-model wan100
python srl.py 32 16 --target R T --embs-model wan300
python srl.py 16 16 --target R T --embs-model wrd50
python srl.py 16 16 --target R T --embs-model glo50
