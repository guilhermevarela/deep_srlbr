...
if __name__== '__main__':	
	...
	# layer_1_cell 		=tf.nn.rnn_cell.BasicLSTMCell(hidden_size[0],  forget_bias=1.0, state_is_tuple=True) 
	# layer_1_cell_fw =tf.nn.rnn_cell.BasicLSTMCell(hidden_size[0],  forget_bias=1.0, state_is_tuple=True) 
	# layer_1_cell_bw =tf.nn.rnn_cell.BasicLSTMCell(hidden_size[0],  forget_bias=1.0, state_is_tuple=True) 
	# layer_2_cell 		=tf.nn.rnn_cell.BasicLSTMCell(hidden_size[1],  forget_bias=1.0, state_is_tuple=True) 
	# layer_2_cell_fw =tf.nn.rnn_cell.BasicLSTMCell(hidden_size[1],  forget_bias=1.0, state_is_tuple=True) 
	# layer_2_cell_bw =tf.nn.rnn_cell.BasicLSTMCell(hidden_size[1],  forget_bias=1.0, state_is_tuple=True) 
